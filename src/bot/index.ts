...
client.on('messageCreate', async (message: Message) => {
  ...
  if (process.env.IS_DEV) {
    ...
    if (message.content === `${prefix}isdev up`) {
      message.reply('Fuck yeah dev is up');
    }
  }
  ...
  if (message.content.startsWith(`${prefix}ammo`)) {
    ...
    const data = <EmbedBuilder>await armorer.request('Name', query, {
      embed: true
    });
  ...
  if (message.content.startsWith(`${prefix}armor`)) {
    ...
    const data = <EmbedBuilder>await tailor.request('Name', query, {
      embed: true
    });
  ...
  if (message.content.startsWith(`${prefix}backpack`)) {
    ...
    const data = <EmbedBuilder>await backpacker.request('Name', query, {
      embed: true
    });
  ...
  if (message.content.startsWith(`${prefix}consume`)) {
    ...
    const data = <EmbedBuilder>await provisioner.request('Name', query, {
      embed: true
    });
  ...
  if (message.content.startsWith(`${prefix}map`)) {
    ...
    const data = <EmbedBuilder>await mapper.request('Name', query, {
      embed: true
    });
  ...
  if (message.content.startsWith(`${prefix}medic`)) {
    ...
    const data = <EmbedBuilder>await medic.request('Name', query, {
      embed: true
    });
  ...
  if (message.content.startsWith(`${prefix}quest`)) {
    ...
    const data = <EmbedBuilder>await quest.request('Quest', query, {
      embed: true
    });
